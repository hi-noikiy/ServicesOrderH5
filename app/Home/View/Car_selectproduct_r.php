		...
		<aside id="offCanvasSide" class="mui-off-canvas-right">
			...
			<ul class="mui-table-view">
				<li class="mui-table-view-cell mui-checkbox mui-left mui-media" style="line-height: 42px;">
					<input name="radio" type="checkbox"><img class="mui-media-object mui-pull-left" src="__PUBLIC__/assets/images/none-car.jpg" width="42" height="42">Item 5<span class="mui-badge mui-badge-danger mui-badge-inverted">￥1400</span>
				</li>
				<li class="mui-table-view-cell mui-checkbox mui-left mui-media" style="line-height: 42px;">
					<input name="radio" type="checkbox"><img class="mui-media-object mui-pull-left" src="__PUBLIC__/assets/images/none-car.jpg" width="42" height="42">Item 5<span class="mui-badge mui-badge-danger mui-badge-inverted">￥1400</span>
				</li>
